...
mod tests {
    ...
    fn test_network_switching() {
        ...
        cli.switch_network(SolanaNetwork::MainnetBeta);
        assert_eq!(cli.get_current_network(), &SolanaNetwork::MainnetBeta);
    }

    #[test]
    fn test_format_balance() {
        let formatted = TSSCli::format_balance(1.5);
    ...
    fn test_help() {
        ...
        assert!(help.contains("balance(address)"));
    }
}
